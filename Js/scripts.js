...
Order.prototype.fullOrder = function () {
  return this.type + " with the crust of " + this.crust + " and " + this.topping + " as your topping.";
};
  ...
  $('form#myForm').submit(function (event) {
      ...
      alert("your bill is: " + newTotal.finalTotal());
          ...
          if(pizzaPick===2){
              ...
              alert("Your order has been received and it will be delivered in a few minutes. Continue to confirm your order");
